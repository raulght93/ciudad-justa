...
function HeroCartel() {
  return (
    <header id="top" className="riso-grain" style={{ position: "relative", overflow: "hidden", maxWidth: maxW, margin: "0 auto",
      ...
      <h1 className="offset-print" style={{ fontFamily: font.display, textTransform: "uppercase", fontSize: "clamp(3.4rem,13vw,11rem)",
        lineHeight: 0.82, letterSpacing: "0.005em", margin: "0 auto", maxWidth: "13ch", position: "relative", zIndex: 1, color: c.text }}>
  ...
  return (
    <header id="top" style={{ position: "relative", overflow: "hidden", borderBottom: `2px solid ${c.text}` }}>
      ...
      <div style={{ maxWidth: maxW, margin: "0 auto", padding: "8px 22px clamp(28px,5vw,52px)" }}>
        <h1 style={{ fontFamily: font.display, textTransform: "uppercase", fontSize: "clamp(3.6rem,15vw,12rem)", lineHeight: 0.8, letterSpacing: "0.005em", color: c.text }}>
          <span style={{ display: "block" }}>{HERO.line1}</span>
          <span style={{ display: "block", textAlign: "right" }}>{HERO.line2pre}<span className="offset-print" style={{ color: c.accent }}>{HERO.line2accent}</span>{HERO.line2post}</span>
        </h1>
